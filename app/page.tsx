    ...
    <div className="">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-16 sm:px-6 text-center gap-20">
        <div className="max-w-4xl space-y-8 relative">
          {/* Background Gradiant */}
          <div
            className="absolute inset-0 -z-10 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/20
          dark:via-indigo-950/20 dark:to-purple-950/20 rounded-3xl scale-150 opacity-60"
          ></div>
          <div className="max-w-4xl space-y-8 relative">
            <h1
              className="text-5xl sm:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600
            via-purple-600 to-indigo-600 dark:from-blue-400 dark:via-purple-400 dark:to-purple-400"
            >
              Connect instantly.
              <br />
              <span
                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400
              dark:to-pink-400"
              >
                Chat smarter.
              </span>
          ...
          <div className="pt-8">
            ...
            <div className="flex justify-center items-center gap-8 text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <div className="text-5m">Messages Sent</div>
              </div>
              <div className="w-px h-8 bg-border"></div>
              <div className="text-center">
                <div className="text-2xl font-bold text-foreground">99.9%</div>
                <div className="text-5m">Uptime</div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-6xl">
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                Everthing you need to stay connected
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-clos-3 gap-8 justify-items-center">
              <FeatureCard
                icon={MessageCircle}
              ...
              <FeatureCard
                ...
                description="Crystal-clear video calls with one click. Prefect quality for personal chats and team meetings."
              />
          ...
          <div className="w-full max-w-4xl">
            <div className="rounded-2xl border bg-gradient-to-br from-primary/5 to-primary/10 p-12 text-center">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Ready to transform your converstaions?
              </h2>
              ...
              <div
                className="flex justify-center flex-col sm:flex-row items-center gap-6 mt-8
